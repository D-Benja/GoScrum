						...
						<div className="flex items-center gap-6">
							...
							{modifiable ? (
								<div className="flex items-center gap-4">
									...
									/>
									<img
										src="/icons/pencil-icon-dark.svg"
										alt=""
										className="h-6 w-6"
									/>
								</div>
						...
						<div className="flex items-center gap-10">
							{modifiable ? (
								<>
									...
									>
										<img
											src="/icons/pencil-icon-light.svg"
											alt=""
											className="h-6 w-6"
										/>
							...
							>
								<img
									src="/icons/trash-bucket-icon-light.svg"
									alt=""
									className="h-6 w-6"
								/>
						...
						<div className="col-span-8 flex flex-col gap-10">
							<div className="flex h-36 w-full items-center gap-20 rounded-2xl border px-16 shadow-md">
								<div className="flex h-full flex-col justify-center gap-2">
									...
									<span className="text-sm">{parseDate(data.createdAt)}</span>
								</div>
								<div className="flex h-full flex-col justify-center gap-2">
									<div className="flex items-center gap-2">
									...
									<span className="text-sm">{parseDate(data.modifiedAt)}</span>
								</div>
								<div className="flex h-full flex-col justify-center gap-2">
									<div className="flex items-center gap-2">
									...
									<span className="text-sm">75% Completed</span>
								</div>
								...
								<div className="h-full">
									...
									<div className="flex h-32 items-center justify-between">
										...
										<div className="flex items-center gap-8">
											<button>
												<img
													src="/icons/comment-alt-icon.svg"
													alt=""
													className="h-6 w-6"
												/>
											</button>
